...
#include "sfm/sqlite3.h"

namespace sfm {

typedef int image_t;
typedef int image_pair_t;
...
public:
    ...
    void
    WriteMatches(const image_t image_id1, const image_t image_id2, const std::vector<cv::DMatch> &matches) const;
